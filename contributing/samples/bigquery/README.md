...
1. Set `CREDENTIALS_TYPE=CredentialsType.ADC` in `agent.py` and run the agent
...
1. Set `CREDENTIALS_TYPE=CredentialsType.SERVICE_ACCOUNT_KEY` in `agent.py`
...
1. Set `CREDENTIALS_TYPE=CredentialsType.OAUTH` in `agent.py` and run the agent
